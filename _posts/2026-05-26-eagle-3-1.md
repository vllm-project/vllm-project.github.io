...
<p align="center">
<img src="/assets/figures/2026-05-26-eagle-3-1/tpot_baseline_vs_eagle31.png" width="95%">
<br>
<em>Figure 2: Per-user output throughput (TPS) on Kimi-K2.6-NVFP4 with vLLM, TP=4, B200 on SPEED-Bench coding. EAGLE 3.1-MLA vs. no-spec baseline.</em>
</p>


## Open-Source Collaboration Across the Ecosystem

This collaboration between the [EAGLE team](https://github.com/SafeAILab/EAGLE), [vLLM team](https://github.com/vllm-project/vllm), and [TorchSpec team](https://github.com/lightseekorg/TorchSpec) represents a strong example of open-source collaboration across algorithm research, system optimization, and training infrastructure.
