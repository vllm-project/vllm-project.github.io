...
As an early data point, we benchmarked the Kimi K2.6 EAGLE 3.1 draft model on Kimi-K2.6-NVFP4 with vLLM (TP=4, GB200) on SPEED-Bench coding. EAGLE 3.1 delivers **2.03× higher per-user output throughput at concurrency 1**, and the speedup stays meaningful as concurrency scales (1.71× at C=4, 1.66× at C=16).

<p align="center">
<img src="/assets/figures/2026-05-26-eagle-3-1/tpot_baseline_vs_eagle31.png" width="90%">
<br>
...
More detailed benchmark results will be shared in a follow-up update.
