...
At least one 8× B300 (or GB300 NVL72) GPU node is required; 16× B200 is also supported. Most production deployments run multi-node with expert and data parallelism, connected over RDMA or NVLink.
