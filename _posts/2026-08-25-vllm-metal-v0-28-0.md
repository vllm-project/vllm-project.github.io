...
| [llama.cpp](https://github.com/ggml-org/llama.cpp) | mask over slots | batched | fixed cells |
| [vllm-metal](https://github.com/vllm-project/vllm-metal) | packed, `cu_seqlens` | batched | paged |

*Prefill attention describes how prompt queries enter the attention kernel: separately, padded to a common length, or concatenated. Decode batching processes multiple requests in one model step. KV describes logical storage: contiguous buffers, individual token cells, or token blocks.*
