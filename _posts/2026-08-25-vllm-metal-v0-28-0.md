...
Our first official release, [v0.28.0](https://github.com/vllm-project/vllm-metal/releases/tag/v0.28.0), aligned vllm-metal's version numbering with upstream vLLM. It introduced batched multi-token prediction (MTP), GGUF and hybrid-model support, and faster prefill on M5. [v0.29.0](https://github.com/vllm-project/vllm-metal/releases/tag/v0.29.0) is now available.
...
Install the current stable release of vllm-metal into its own virtual environment and activate it:
