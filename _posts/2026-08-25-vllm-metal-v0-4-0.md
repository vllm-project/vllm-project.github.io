...
<!-- TODO before publish: fill this in. Needs an M1 Pro agent-split run; SiliconBench
     currently has m5pro/ and dgxspark/ but no m1pro/ for the agent split. -->

*Placeholder — M1 Pro and M5 Pro on the same agent split.*
