...
summary: "vllm-metal v0.4.0 brings vLLM's paged, continuously batched serving stack to Apple Silicon, with flatter TTFT under concurrent agent load, batched MTP, and automatic M5 prefill acceleration."
...
![SiliconBench agent split on Gemma 4 E4B and Qwen3.8-27B, vllm-metal on an M5 Pro against upstream vLLM on a DGX Spark: TTFT, end-to-end request latency, and output token throughput versus concurrency](/assets/figures/2026-08-25-vllm-metal-v0-4-0/spark-vs-apple.svg)
