...
What matters in v0.2 is that this is already tangible, not just conceptual. Through built-in MCP tools and room-style chat workflows, users can create and manage large numbers of teams and workers, coordinate them in real time, and observe the runtime state of the whole multi-claw system from one place.
...
- **built-in MCP integration** so users can create and manage large numbers of teams and workers directly through chat
