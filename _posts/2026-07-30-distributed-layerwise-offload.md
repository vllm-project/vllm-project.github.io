...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 300" style="width:100%;max-width:780px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <!-- Time axis -->
  <line x1="80" y1="25" x2="740" y2="25" stroke="#999" stroke-width="1"/>
  <polygon points="740,25 735,22 735,28" fill="#999"/>
  <text x="745" y="29" fill="#999" font-size="11">Time</text>

  <!-- Row labels -->
  <text x="10" y="75" font-size="12" font-weight="600" fill="#333">Compute</text>
  <text x="10" y="125" font-size="12" font-weight="600" fill="#333">H2D</text>
  <text x="10" y="165" font-size="12" font-weight="600" fill="#333">AllGather</text>
  <text x="10" y="220" font-size="12" font-weight="600" fill="#333">Slot 0</text>
  <text x="10" y="255" font-size="12" font-weight="600" fill="#333">Slot 1</text>

  <!-- Row separators -->
  <line x1="75" y1="55" x2="75" y2="280" stroke="#ddd" stroke-width="1"/>

  <!-- Compute blocks (blue) -->
  <rect x="80" y="55" width="150" height="35" rx="4" fill="#4A90D9" stroke="#2E6FA8" stroke-width="1.5"/>
  <text x="155" y="78" text-anchor="middle" fill="white" font-size="12" font-weight="600">Layer N</text>
  <text x="155" y="50" text-anchor="middle" fill="#2E6FA8" font-size="10">Slot 0</text>

  <rect x="295" y="55" width="150" height="35" rx="4" fill="#4A90D9" stroke="#2E6FA8" stroke-width="1.5"/>
  <text x="370" y="78" text-anchor="middle" fill="white" font-size="12" font-weight="600">Layer N+1</text>
  <text x="370" y="50" text-anchor="middle" fill="#2E6FA8" font-size="10">Slot 1</text>

  <rect x="510" y="55" width="150" height="35" rx="4" fill="#4A90D9" stroke="#2E6FA8" stroke-width="1.5"/>
  <text x="585" y="78" text-anchor="middle" fill="white" font-size="12" font-weight="600">Layer N+2</text>
  <text x="585" y="50" text-anchor="middle" fill="#2E6FA8" font-size="10">Slot 0</text>

  <!-- H2D blocks (orange) -->
  <rect x="80" y="110" width="100" height="25" rx="4" fill="#F5A623" stroke="#D4860B" stroke-width="1.5"/>
  <text x="130" y="127" text-anchor="middle" fill="white" font-size="11">H2D N+1</text>

  <rect x="295" y="110" width="100" height="25" rx="4" fill="#F5A623" stroke="#D4860B" stroke-width="1.5"/>
  <text x="345" y="127" text-anchor="middle" fill="white" font-size="11">H2D N+2</text>

  <rect x="510" y="110" width="100" height="25" rx="4" fill="#F5A623" stroke="#D4860B" stroke-width="1.5"/>
  <text x="560" y="127" text-anchor="middle" fill="white" font-size="11">H2D N+3</text>

  <!-- AllGather blocks (green) -->
  <rect x="180" y="150" width="80" height="25" rx="4" fill="#7ED321" stroke="#5BA816" stroke-width="1.5"/>
  <text x="220" y="167" text-anchor="middle" fill="white" font-size="11">AG N+1</text>

  <rect x="395" y="150" width="80" height="25" rx="4" fill="#7ED321" stroke="#5BA816" stroke-width="1.5"/>
  <text x="435" y="167" text-anchor="middle" fill="white" font-size="11">AG N+2</text>

  <rect x="610" y="150" width="80" height="25" rx="4" fill="#7ED321" stroke="#5BA816" stroke-width="1.5"/>
  <text x="650" y="167" text-anchor="middle" fill="white" font-size="11">AG N+3</text>

  <!-- Event sync arrows (dashed) -->
  <path d="M 260 165 L 295 90" stroke="#E74C3C" stroke-width="1.5" stroke-dasharray="4,3" fill="none" marker-end="url(#arrowR)"/>
  <path d="M 475 165 L 510 90" stroke="#E74C3C" stroke-width="1.5" stroke-dasharray="4,3" fill="none" marker-end="url(#arrowR)"/>
  ...
  <!-- Slot 0 row -->
  <rect x="80" y="205" width="150" height="22" rx="3" fill="#E8F0FA" stroke="#4A90D9" stroke-width="1" stroke-dasharray="3,2"/>
  <text x="155" y="220" text-anchor="middle" fill="#2E6FA8" font-size="10">Layer N weights</text>
  <path d="M 230 216 L 505 216" stroke="#4A90D9" stroke-width="1" stroke-dasharray="3,3" marker-end="url(#arrowB)"/>
  <rect x="510" y="205" width="150" height="22" rx="3" fill="#E8F0FA" stroke="#4A90D9" stroke-width="1"/>
  <text x="585" y="220" text-anchor="middle" fill="#2E6FA8" font-size="10">Layer N+2 weights</text>

  <!-- Slot 1 row -->
  <rect x="295" y="240" width="150" height="22" rx="3" fill="#FFF4E0" stroke="#F5A623" stroke-width="1" stroke-dasharray="3,2"/>
  <text x="370" y="255" text-anchor="middle" fill="#D4860B" font-size="10">Layer N+1 weights</text>
  <path d="M 445 251 L 605 251" stroke="#F5A623" stroke-width="1" stroke-dasharray="3,3" marker-end="url(#arrowO)"/>
  <rect x="610" y="240" width="80" height="22" rx="3" fill="#FFF4E0" stroke="#F5A623" stroke-width="1" stroke-dasharray="3,2"/>
  <text x="650" y="255" text-anchor="middle" fill="#D4860B" font-size="10">N+3 (prep)</text>
  ...
  <!-- Legend -->
  <rect x="80" y="280" width="14" height="14" rx="2" fill="#4A90D9"/>
  <text x="100" y="291" font-size="10" fill="#666">GPU compute</text>
  <rect x="180" y="280" width="14" height="14" rx="2" fill="#F5A623"/>
  <text x="200" y="291" font-size="10" fill="#666">H2D copy</text>
  <rect x="270" y="280" width="14" height="14" rx="2" fill="#7ED321"/>
  <text x="290" y="291" font-size="10" fill="#666">AllGather</text>
  <line x1="360" y1="287" x2="390" y2="287" stroke="#E74C3C" stroke-width="1.5" stroke-dasharray="4,3" marker-end="url(#arrowR)"/>
  <text x="395" y="291" font-size="10" fill="#666">Event sync (compute waits for AG)</text>
</svg>
