...
image: /assets/figures/2026-09-10-minimax-m3-mi355x/hero-fixed-workload-progress.svg
social_image: /assets/figures/2026-09-10-minimax-m3-mi355x/hero-fixed-workload-progress.svg
tags:
  - hardware
  - performance
  - moe
...
![MiniMax M3 fixed-workload serving progress on AMD Instinct MI355X](/assets/figures/2026-09-10-minimax-m3-mi355x/hero-fixed-workload-progress.svg)
...
![MiniMax M3 decode critical path and P/D system boundary](/assets/figures/2026-09-10-minimax-m3-mi355x/optimization-map.svg)
...
![How TP sharding changes the local GEMM shape and tile plan](/assets/figures/2026-09-10-minimax-m3-mi355x/local-shape-tile-selection.svg)
...
![MiniMax M3 shared-expert execution before and after fusion](/assets/figures/2026-09-10-minimax-m3-mi355x/shared-expert-fusion.svg)
...
![How vLLM adapts MiniMax M3 sparse blocks to AITER pages without copying KV data](/assets/figures/2026-09-10-minimax-m3-mi355x/sparse-page-adapter.svg)
...
![QuickReduce configuration, eligibility, codec selection, and execution gates](/assets/figures/2026-09-10-minimax-m3-mi355x/quickreduce-dispatch-gates.svg)
...
![Two independently tuned MiniMax M3 P/D system profiles](/assets/figures/2026-09-10-minimax-m3-mi355x/pd-system-profiles.svg)
