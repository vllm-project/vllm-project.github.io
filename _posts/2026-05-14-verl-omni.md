...
<div align="center">
  ...
  <br/>
  <small>
    FlowGRPO Demonstration. FlowGRPO is an online policy method for flow-matching models. It employs multi-step SDE sampling with a diffusion policy model to enable effective RL exploration, and adopts model-based rewards to assess generation quality. 
  </small>
</div>



The training workflow mainly consists of four key stages:
