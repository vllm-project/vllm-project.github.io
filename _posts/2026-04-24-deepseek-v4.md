...
For more deployment strategies, including disaggregated serving/more GPU architectures, please refer to the [recipes](https://recipes.vllm.ai/DeepSeek/DeepSeek-V4-Pro.html).
...
For more deployment strategies, including disaggregated serving/more GPU architectures, please refer to the [recipes](https://recipes.vllm.ai/DeepSeek/DeepSeek-V4-Flash.html).
