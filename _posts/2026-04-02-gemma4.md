...
For technical implementation details, refer to the official [model card](https://huggingface.co/collections/google/gemma-4) and community [recipes](https://github.com/vllm-project/recipes/tree/main/Google).
