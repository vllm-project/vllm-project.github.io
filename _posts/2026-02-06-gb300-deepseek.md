...
Meanwhile, with 2x GB300 GPUs (EP=2), **DeepSeek-R1** (FP4) can achieve a prefill throughput of <span style="color: #2ecc71; font-weight: 600;">22476 TGS</span> per GPU _(ISL=2K, batch=256)_, and reach **3072 TGS** per GPU in a _(ISL=2k,OSL=1K)_ context mixed scenario.

Compared to the **Hopper** series, the **B300** series demonstrates an <span style="color: #2ecc71; font-weight: 600;">8x</span> performance improvement during Prefill, and <span style="color: #2ecc71; font-weight: 600;">10-20x</span> improvement in P/D mixed scenarios.
